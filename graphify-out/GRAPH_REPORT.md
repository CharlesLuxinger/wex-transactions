...
## Corpus Check
- 99 files · ~50,059 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 654 nodes · 555 edges · 99 communities detected
...
1. `RetrieveConvertedControllerV1IntegrationTest` - 23 edges
2. `BigDecimalExtensionsTest` - 21 edges
3. `ExchangeRateTreasuryAdapterTest` - 21 edges
4. `ExchangeRateTest` - 19 edges
5. `PurchaseTest` - 18 edges
6. `TransactionDateTest` - 17 edges
7. `GlobalExceptionHandler` - 15 edges
8. `RetrieveConvertedUseCaseImplTest` - 15 edges
9. `TargetCurrencyTest` - 15 edges
10. `GlobalExceptionHandlerTest` - 15 edges
...
Cohesion: 0.33
Nodes (1): ExchangeRateLookupWindowTest
...
Cohesion: 0.33
Nodes (1): TreasuryApiRateLimiterTest
...
Cohesion: 0.5
Nodes (1): ExchangeRateLookupWindow
...
Cohesion: 0.67
Nodes (1): TreasuryLiveSmokeTest

### Community 83 - "Community 83"
Cohesion: 0.67
Nodes (1): ActuatorHealthIntegrationTest
...
Cohesion: 1.0
Nodes (1): IdempotencyKeyConflictException
...
- **Thin community `Community 84`** (2 nodes): `ExchangeRateFetchedEvent.kt`, `ExchangeRateFetchedEvent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `toMonetaryScale()`, `BigDecimalExtensions.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `IdempotencyKeyConflictException.kt`, `IdempotencyKeyConflictException`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `StorePurchaseCommand.kt`, `StorePurchaseCommand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `StorePurchaseRequest.kt`, `StorePurchaseRequest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `StorePurchaseResponse.kt`, `StorePurchaseResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `RetrieveConvertedQuery.kt`, `RetrieveConvertedQuery`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (2 nodes): `RetrieveConvertedResponse.kt`, `RetrieveConvertedResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `UuidExtensions.kt`, `toTraceId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (2 nodes): `AopLoggingConfig`, `AopLoggingConfig.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `TestContainersConfig.kt`, `TestContainersConfig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `settings.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `IdempotencyKeyRedisAdapter.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `ApplicationFlowLoggingAspect.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **What connects `Application`, `PersistenceConfig`, `ExchangeRateFetchedEvent` to the rest of the system?**
